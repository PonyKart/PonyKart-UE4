...
public:
	...
	// owner:Which kart is the wheel attached to?
	// connectionPoint:Where is the wheel attached?
	// wheelID:ID number of the wheel
	// dict:The properties and values from the .wheel file this wheel was built from
	// meshName:The filename of the mesh we should use for this wheel
