...
class LThing // Our game object class! Pretty much everything you see in the game uses this
{
public:
	...
	void runScript(); // Runs the thing's script, if it has one. If this thing was made from a .muffin, this is called from Level.RunLevelScripts to make sure it runs after everything else is created. If it was made on the fly, it runs at the end of the constructor, as long as it's a valid level of course.
	// Getters
...
protected:
	...
	virtual void preSetup(PonykartParsers::ThingBlock* thingTemplate, PonykartParsers::ThingDefinition* def){}; // Use this method if you need some more stuff to happen before the constructor starts setting everything up. For example if you need to get more things out of the ThingTemplate, you can use this for that.
