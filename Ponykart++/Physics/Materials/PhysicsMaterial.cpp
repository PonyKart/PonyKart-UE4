...
const float PhysicsMaterial::DEFAULT_FRICTION=0.3;
const float PhysicsMaterial::DEFAULT_BOUNCINESS=0.3;
const float PhysicsMaterial::DEFAULT_ANGULAR_DAMPING=0.3;
const float PhysicsMaterial::DEFAULT_LINEAR_DAMPING=0.3;
